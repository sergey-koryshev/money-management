...
namespace Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250726142527_RemoveEmptyDescriptions")]
    partial class RemoveEmptyDescriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Domain.Entities.AnnouncementType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DismissedAnnouncements", b =>
                {
                    ...
                    b.HasKey("AnnouncementId", "PersonId");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Announcement", b =>
                {
                    b.HasOne("Backend.Domain.Entities.AnnouncementType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("DismissedAnnouncements", b =>
                {
                    b.HasOne("Backend.Domain.Entities.Announcement", null)
                        .WithMany()
